...
import org.apache.dubbo.common.extensionloader.activate.impl.ActivateExt1Impl1;
import org.apache.dubbo.common.extensionloader.activate.impl.GroupActivateExtImpl;
import org.apache.dubbo.common.extensionloader.activate.impl.OrderActivateExtImpl1;
import org.apache.dubbo.common.extensionloader.activate.impl.OrderActivateExtImpl2;
import org.apache.dubbo.common.extensionloader.activate.impl.ValueActivateExtImpl;
import org.apache.dubbo.common.extensionloader.ext1.SimpleExt;
import org.apache.dubbo.common.extensionloader.ext1.impl.SimpleExtImpl1;
import org.apache.dubbo.common.extensionloader.ext1.impl.SimpleExtImpl2;
...
import org.apache.dubbo.common.extensionloader.ext6_wrap.impl.Ext5Wrapper1;
import org.apache.dubbo.common.extensionloader.ext6_wrap.impl.Ext5Wrapper2;
...
import org.apache.dubbo.common.extensionloader.ext8_add.AddExt3;
import org.apache.dubbo.common.extensionloader.ext8_add.AddExt4;
import org.apache.dubbo.common.extensionloader.ext8_add.impl.AddExt1Impl1;
import org.apache.dubbo.common.extensionloader.ext8_add.impl.AddExt1_ManualAdaptive;
import org.apache.dubbo.common.extensionloader.ext8_add.impl.AddExt1_ManualAdd1;
import org.apache.dubbo.common.extensionloader.ext8_add.impl.AddExt1_ManualAdd2;
import org.apache.dubbo.common.extensionloader.ext8_add.impl.AddExt2_ManualAdaptive;
import org.apache.dubbo.common.extensionloader.ext8_add.impl.AddExt3_ManualAdaptive;
...
public class ExtensionLoaderTest {
    ...
    public void test_getExtensionLoader_NotInterface() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(),
                    containsString("Extension type(class org.apache.dubbo.common.extensionloader.ExtensionLoaderTest) is not interface"));
        }
    }
    ...
    public void test_getExtensionLoader_NotSpiAnnotation() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(),
                    allOf(containsString("org.apache.dubbo.common.extensionloader.NoSpiExt"),
    ...
    public void test_getExtension_ExceptionNoExtension() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), containsString("No such extension org.apache.dubbo.common.extensionloader.ext1.SimpleExt by name XXX"));
        }
    }
    ...
    public void test_getExtension_ExceptionNoExtension_WrapperNotAffactName() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), containsString("No such extension org.apache.dubbo.common.extensionloader.ext6_wrap.WrappedExt by name XXX"));
        }
    }
    ...
    public void test_AddExtension() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), containsString("No such extension org.apache.dubbo.common.extensionloader.ext8_add.AddExt1 by name Manual"));
        }
...
//        ExtensionLoader.getExtensionLoader(Ext9Empty.class).getSupportedExtensions();
    ...
    public void test_AddExtension_ExceptionWhenExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Extension name impl1 already existed(Extension interface org.apache.dubbo.common.extensionloader.ext8_add.AddExt1)!"));
        }
    }
    ...
    public void test_AddExtension_Adaptive_ExceptionWhenExistedAdaptive() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Adaptive Extension already existed(Extension interface org.apache.dubbo.common.extensionloader.ext8_add.AddExt1)!"));
        }
    }
    ...
    public void test_replaceExtension_ExceptionWhenNotExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Extension name NotExistedExtension not existed(Extension interface org.apache.dubbo.common.extensionloader.ext8_add.AddExt1)"));
        }
    }
    ...
    public void test_replaceExtension_Adaptive_ExceptionWhenNotExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Adaptive Extension not existed(Extension interface org.apache.dubbo.common.extensionloader.ext8_add.AddExt4)"));
        }
    }
    ...
    public void test_InitError() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Failed to load extension class(interface: interface org.apache.dubbo.common.extensionloader.ext7.InitErrorExt"));
