...
public class FileSystemDynamicConfigurationFactoryTest {
    ...
    public void testGetFactory() {
        ...
        assertEquals("org.apache.dubbo.common.config.configcenter.InternalDynamicConfiguration", factory.getDynamicConfiguration(URL.valueOf("dummy")).getClass().getName());
    }
}
