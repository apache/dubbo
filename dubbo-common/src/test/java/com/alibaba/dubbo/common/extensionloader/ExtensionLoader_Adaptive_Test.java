...
public class ExtensionLoader_Adaptive_Test {
	...
	public void test_urlHolder_getAdaptiveExtension_UrlNpe() throws Exception {
		...
		try {
			...
			assertEquals("com.alibaba.dubbo.common.extensionloader.ext2.UrlHolder argument getUrl() == null",
					e.getMessage());
		}
	}
	...
	public void test_urlHolder_getAdaptiveExtension_ExceptionWhenNameNotProvided() throws Exception {
		...
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("Fail to get extension(com.alibaba.dubbo.common.extensionloader.ext2.Ext2) name from url"));
		}
	}
