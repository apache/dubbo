...
public class ConfigUtilsTest {
	...
	public void testMergeValuesDeleteDefault() {
		List<String> merged = ConfigUtils.mergeValues(Serialization.class, "-default",
				toArray("dubbo", "default.hessian2", "json"));
	...
	public void testMergeValuesDeleteDefault_2() {
		List<String> merged = ConfigUtils.mergeValues(Serialization.class, "-default,aaa",
				toArray("dubbo", "default.hessian2", "json"));
	...
	public void testMergeValuesDelete() {
		List<String> merged = ConfigUtils.mergeValues(Serialization.class, "-dubbo,aaa",
				toArray("dubbo", "default.hessian2", "json"));
	...
	public void test_loadProperties_oneFile_notRootPath() throws Exception {
		Properties p = ConfigUtils.loadProperties(
				"META-INF/dubbo/internal/com.alibaba.dubbo.common.threadpool.ThreadPool", false);
	...
	public void test_loadProperties_multiFile_notRootPath_Exception() throws Exception {
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("only 1 META-INF/services/com.alibaba.dubbo.common.status.StatusChecker file is expected, but 2 dubbo.properties files found on class path:"));
		}
	}
	...
	public void test_loadProperties_multiFile_notRootPath() throws Exception {
		...
		Properties p = ConfigUtils.loadProperties(
				"META-INF/dubbo/internal/com.alibaba.dubbo.common.status.StatusChecker", true);
