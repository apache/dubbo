...
public class UrlUtilsTest {
	...
	public void testSubscribe2() {
		...
		Map<String, String> newSubscribe = UrlUtils.convertSubscribe(subscribe);
		assertEquals("dubbo.version=2.0.0&group=test&version=1.0.0",
	...
	public void testIsServiceKeyMatch() throws Exception {
		...
		URL pattern = url.addParameter(Constants.GROUP_KEY, "test").addParameter(Constants.INTERFACE_KEY, "test")
