...
public class SerializationCompareTest {
	...
	public void testBuilderPerm() throws Exception {
		...
		System.out.println("Builder write and parse 500 times in " + (System.currentTimeMillis() - now) + "ms, size "
				+ len);
	}
	...
	public void testH2oPerm() throws Exception {
		...
		System.out.println("Hessian2 write and parse 500 times in " + (System.currentTimeMillis() - now) + "ms, size "
				+ len);
	}
	...
	public void testJavaOutputPerm() throws Exception {
		...
		System.out.println("java write and parse 500 times in " + (System.currentTimeMillis() - now) + "ms, size "
				+ len);
	}
	...
	public void testCompactedJavaOutputPerm() throws Exception {
		...
		System.out.println("compacted java write and parse 500 times in " + (System.currentTimeMillis() - now)
				+ "ms, size " + len);
	}
