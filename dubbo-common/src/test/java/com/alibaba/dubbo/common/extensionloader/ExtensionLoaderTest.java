...
public class ExtensionLoaderTest {
		...
		try {
			...
			assertThat(
					...
					allOf(containsString("com.alibaba.dubbo.common.extensionloader.NoSpiExt"),
							containsString("is not extension"), containsString("WITHOUT @SPI Annotation")));
		}
	}
	...
	public void test_getExtension_ExceptionNoExtension() throws Exception {
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("No such extension com.alibaba.dubbo.common.extensionloader.ext1.SimpleExt by name XXX"));
		}
	}
	...
	public void test_getExtension_ExceptionNoExtension_WrapperNotAffactName() throws Exception {
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("No such extension com.alibaba.dubbo.common.extensionloader.ext6_wrap.WrappedExt by name XXX"));
		}
	}
	...
	public void test_AddExtension() throws Exception {
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("No such extension com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt1 by name Manual"));
		}
		...
		assertEquals("Manual1",
				ExtensionLoader.getExtensionLoader(AddExt1.class).getExtensionName(AddExt1_ManualAdd1.class));
	}
	...
	public void test_AddExtension_ExceptionWhenExistedExtension() throws Exception {
		...
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("Extension name impl1 already existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt1)!"));
		}
	}
	...
	public void test_AddExtension_Adaptive_ExceptionWhenExistedAdaptive() throws Exception {
		...
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("Adaptive Extension already existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt1)!"));
		}
	}
	...
	public void test_replaceExtension() throws Exception {
...

		{
			...
			assertEquals("impl1", ExtensionLoader.getExtensionLoader(AddExt1.class)
					.getExtensionName(AddExt1Impl1.class));
		}
		{
			...
			assertEquals("impl1",
					ExtensionLoader.getExtensionLoader(AddExt1.class).getExtensionName(AddExt1_ManualAdd2.class));
		}
	}
	...
	public void test_replaceExtension_ExceptionWhenNotExistedExtension() throws Exception {
		...
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("Extension name NotExistedExtension not existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt1)"));
		}
	}
	...
	public void test_replaceExtension_Adaptive_ExceptionWhenNotExistedExtension() throws Exception {
		...
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("Adaptive Extension not existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt4)"));
		}
	}
	...
	public void test_InitError() throws Exception {
		...
		try {
			...
			assertThat(
					expected.getMessage(),
					containsString("Failed to load extension class(interface: interface com.alibaba.dubbo.common.extensionloader.ext7.InitErrorExt"));
	...
	public void testLoadActivateExtension() throws Exception {
		...
		List<ActivateExt1> list = ExtensionLoader.getExtensionLoader(ActivateExt1.class).getActivateExtension(url,
		...
		list = ExtensionLoader.getExtensionLoader(ActivateExt1.class).getActivateExtension(url, new String[] {},
				"group1");
		Assert.assertEquals(1, list.size());
