...
public class JSONTest extends TestCase {
	public void testException() throws Exception {
		...
		// Assert.assertEquals("{\"code\":\"001\",\"message\":\"AAAAAAAA\"}",
		// json);
	...
	public void testParse2JSONObject() throws Exception {
		JSONObject jo = (JSONObject) JSON
				.parse("{name:'qianlei',array:[1,2,3,4,98.123],b1:TRUE,$1:NULL,$2:FALSE,__3:NULL}");
	...
	public void testParse2Class() throws Exception {
		...
		Bean bean = JSON
				.parse("{name:'qianlei',array:[1,2,3,4,98.123],displayName:'钱磊',$$:214726,$b:TRUE}", Bean.class);
	...
	public void testParse2Arguments() throws Exception {
		Object[] test = JSON.parse("[1.2, 2, {name:'qianlei',array:[1,2,3,4,98.123]} ]", new Class<?>[] { int.class,
				int.class, Bean.class });
