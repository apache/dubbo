...
/**
 * Utilities used to read configuration from .properties sources, for example, dubbo.properties.
 * Renamed from ConfigUtils.
 */
        ...
        if (PROPERTIES == null) {
            synchronized (PropertiesUtils.class) {
                if (PROPERTIES == null) {
                    ...
                    PROPERTIES = PropertiesUtils.loadProperties(path, false, true);
                }
            }
        }
        return PROPERTIES;
