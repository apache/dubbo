...
<<<<<<< HEAD:dubbo-metadata/dubbo-metadata-api/src/main/java/org/apache/dubbo/metadata/definition/model/ServiceDefinition.java
=======
    public List<String> getAnnotations() {
        if (annotations == null) {
            annotations = Collections.emptyList();
...
>>>>>>> origin/3.2:dubbo-common/src/main/java/org/apache/dubbo/metadata/definition/model/ServiceDefinition.java
