...
public final class DefaultTypeBuilder {
    ...
    public static TypeDefinition build(Class<?> clazz, Map<String, TypeDefinition> typeCache) {
        ...
        // Custom type
<<<<<<< HEAD:dubbo-metadata/dubbo-metadata-api/src/main/java/org/apache/dubbo/metadata/definition/builder/DefaultTypeBuilder.java
...
>>>>>>> origin/3.2:dubbo-common/src/main/java/org/apache/dubbo/metadata/definition/builder/DefaultTypeBuilder.java
        }
