...
public class WasmInitException extends RuntimeException {
    ...
    public WasmInitException(Throwable cause) {
        super(cause);
    }

    public WasmInitException(String message, Throwable cause) {
        super(message, cause);
    }
}
