...
public class Route extends Entity {
	...
	public String toString() {
		return "Route [parentId=" + parentId + ", name=" + name + ", serviceName=" + service + ", matchRule="
				+ matchRule + ", filterRule=" + filterRule + ", priority=" + priority + ", username=" + username
				+ ", enabled=" + enabled + "]";
	}
	...
	public URL toUrl() {
		...
		return URL.valueOf(Constants.ROUTE_PROTOCOL + "://" + Constants.ANYHOST_VALUE + "/" + path + "?"
				...
				+ "&router=condition&runtime=false&enabled=" + isEnabled() + "&priority=" + getPriority() + "&force="
				+ isForce() + "&dynamic=false" + "&name=" + getName() + "&" + Constants.RULE_KEY + "="
