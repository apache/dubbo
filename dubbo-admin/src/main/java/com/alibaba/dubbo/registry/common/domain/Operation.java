...
public class Operation extends Entity {
	...
	public static final List<String> TYPES = Collections.unmodifiableList(Arrays.asList(new String[] { PROVIDER_TYPE,
			CONSUMER_TYPE, ROUTE_TYPE, WEIGHT_TYPE, CLUSTER_TYPE, DOCUMENT_TYPE, LOADBALANCE_TYPE, TEST_TYPE,
