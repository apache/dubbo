...
public class SyncUtils {
	...
	public static <SM extends Map<String, Map<Long, URL>>> Map<Long, URL> filterFromCategory(Map<String, SM> urls,
	...
	public static <SM extends Map<String, Map<Long, URL>>> Pair<Long, URL> filterFromCategory(Map<String, SM> urls,
		...
		for (Map.Entry<String, Map<Long, URL>> e1 : services.entrySet()) {
			...
			if (u.containsKey(id))
				return new Pair<Long, URL>(id, u.get(id));
		}
		return null;
	}
}
