...
public class RouteRuleTest {
	...
	/*
	 * @org.junit.Test public void testParse_EmptyWhen() { try{
	 * RouteRule.parse("",
	 * "provider.application=morgan&provider.host=10.16.26.51&provider.port=1020"
	 * ); fail(); }catch(ParseException expected){
	 * assertThat(expected.getMessage(),
	 * JUnitMatchers.containsString("Illegal route rule without when express"));
	 * } }
	 */
	...
	public void testParse_MatchRight() throws Exception {
		...
		assertEquals(
				RouteRule.createFromCondition(whenParams, thenParams),
				RouteRule
						.parse("service=com.alibaba.MemberService,AuthService&consumer.host=127.0.0.1,17.58.25.62&consumer.version = 1.0.0,1.0.6",
	...
	public void testParse_MisMatchRight() throws Exception {
		...
		assertEquals(
				RouteRule.createFromCondition(whenParams, thenParams),
				RouteRule
						.parse("service!=com.alibaba.MemberService,AuthService&consumer.host!=127.0.0.1&consumer.version != 1.0.0,1.0.6",
								"provider.application!=morgan,pc2&provider.host!=10.16.26.51&provider.port!=1020"));
	}
	...
	public void testParse_Simple() throws Exception {
		...
		assertEquals(RouteRule.createFromCondition(whenParams, thenParams), RouteRule.parse(
				"service=com.alibaba.morgan.*&service!=com.alibaba.morgan.MemberService", "provider.host=10.16.26.51"));
	}
	...
	public void testParse_AllRight() throws Exception {
		...
		assertEquals(RouteRule.createFromCondition(whenParams, thenParams), RouteRule.parse(
				"service=com.alibaba.MemberService,AuthService&service!=com.alibaba.DomainService,com.alibaba.ViewCacheService"
	...
	public void testParseRule_complex() throws Exception {
		Map<String, RouteRule.MatchPair> when = RouteRule
				.parseRule("when1=valueW1 ,valueW1 & when2 = valueW2,valueW3, valueW4 & when2 != valueWu,valueWv & when3!=valueWx,valueWy");
		Map<String, RouteRule.MatchPair> then = RouteRule
				.parseRule("then1 = valueT1 & then2 = valueT2,valueT3,   valueT4");
	...
	public void test_Parse_StringString() throws Exception {
		RouteRule rule = RouteRule
				.parse("when1=valueW1 ,valueW1 & when2 = valueW2,valueW3, valueW4 & when2 != valueWu,valueWv & when3!=valueWx,valueWy",
	...
	public void test_Parse_String() throws Exception {
		{
			RouteRule rule1 = RouteRule.parse("", "then1 = valueT1 & then2 = valueT2,valueT3,   valueT4");
		...
		{
			RouteRule rule1 = RouteRule
					.parse("when1=valueW1 ,valueW1 & when2 = valueW2,valueW3, valueW4 & when2 != valueWu,valueWv & when3!=valueWx,valueWy",
							"then1 = valueT1 & then2 = valueT2,valueT3,   valueT4");
			RouteRule rule2 = RouteRule
					.parse("when1=valueW1 ,valueW1 & when2 = valueW2,valueW3, valueW4 & when2 != valueWu,valueWv & when3!=valueWx,valueWy"
							+ " => then1 = valueT1 & then2 = valueT2,valueT3,   valueT4");
	...
	public void test_isWhenContainValue() throws Exception {
		RouteRule r = RouteRule
				.parse("when1 = valueW1 & when3 != valueWx,valueWy & when2 = valueW4,valueW2,valueW3 & when2 != valueWu,valueWv",
	...
	public void test_copyWithRemove() throws Exception {
		...
		}
		{
			...
			assertEquals(
					RouteRule.parse(
							"when1 = valueW1 & when3 != valueWx,valueWy & when2 = valueW4,valueW2,valueW3 & when2 != valueWu,valueWv",
