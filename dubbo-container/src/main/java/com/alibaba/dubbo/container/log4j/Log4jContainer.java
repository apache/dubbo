...
public class Log4jContainer implements Container {
    ...
    public void start() {
        String file = System.getProperty(LOG4J_FILE, System.getProperty("dubbo.logging.root")); // compatible
        if (file == null || file.length() == 0) {
            file = DEFAULT_LOG4J_FILE;
        }
        String level = System.getProperty(LOG4J_LEVEL, System.getProperty("dubbo.logging.level")); // compatible
        ...
        String subdirectory = System.getProperty(LOG4J_SUBDIRECTORY, System.getProperty("dubbo.service.server.port")); // compatible
