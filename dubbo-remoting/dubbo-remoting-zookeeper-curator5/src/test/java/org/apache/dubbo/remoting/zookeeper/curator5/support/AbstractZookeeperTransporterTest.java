...
public class AbstractZookeeperTransporterTest {
    ...
    private AbstractZookeeperTransporter abstractZookeeperTransporter = new Curator5ZookeeperTransporter();
    ...
    public void setUp() throws Exception {        
        zookeeperClient = abstractZookeeperTransporter.connect(URL.valueOf(zookeeperConnectionAddress1 + "/service"));
    }
    ...
    public void testSameZkClientSharedByMultipleApplications() throws Exception {
        URL url = URL.valueOf(zookeeperConnectionAddress2 + "/org.apache.dubbo.registry.RegistryService?backup=127.0.0.1:" + zookeeperServerPort2 + "&application=provider1&dubbo=2.0.2&interface=org.apache.dubbo.registry.RegistryService&pid=47418&specVersion=2.7.0-SNAPSHOT&timestamp=1547102428828");
        URL url2 = URL.valueOf(zookeeperConnectionAddress2 + "/org.apache.dubbo.registry.RegistryService?backup=127.0.0.1:" + zookeeperServerPort2 + "&application=provider2&dubbo=2.0.2&interface=org.apache.dubbo.registry.RegistryService&pid=47418&specVersion=2.7.0-SNAPSHOT&timestamp=1547102428828");
        ZookeeperClient newZookeeperClient = abstractZookeeperTransporter.connect(url);
        //just for connected
        newZookeeperClient.getContent("/dubbo/test");
        Assertions.assertEquals(abstractZookeeperTransporter.getZookeeperClientMap().size(), 2);
        Assertions.assertEquals(abstractZookeeperTransporter.getZookeeperClientMap().get("127.0.0.1:" + zookeeperServerPort2), newZookeeperClient);
