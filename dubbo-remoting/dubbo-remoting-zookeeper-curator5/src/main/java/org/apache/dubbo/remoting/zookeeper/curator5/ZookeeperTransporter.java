...
public interface ZookeeperTransporter {
    ...
    Map<ApplicationModel, ZookeeperTransporter> transporterMap = new ConcurrentHashMap<>();
    ...
    static ZookeeperTransporter getInstance(ApplicationModel applicationModel) {
        if (!transporterMap.containsKey(applicationModel) || transporterMap.get(applicationModel) == null) {
            ...
            transporterMap.put(applicationModel, transporter);
        }
        return transporterMap.get(applicationModel);
    }
}
