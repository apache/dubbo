...
public class TestCodecs {
    ...
    void testUrlForm(){
        ...
        HttpMessageCodec codec = new UrlEncodeFormCodec(FrameworkModel.defaultModel().getBeanFactory().getBean(ConverterUtil.class));
    ...
    void testXml(){
        ...
        Assertions.assertEquals("New York",user.getUsername());
    }
