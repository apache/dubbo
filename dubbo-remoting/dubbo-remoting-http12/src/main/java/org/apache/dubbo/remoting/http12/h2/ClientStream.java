 ...
 * received by {@link Listener} Requests are sent by {@link ClientStream} directly.
 */
public interface ClientStream extends Stream {
    ...
    interface Listener extends Stream.Listener {
         ...
         */
        default void onComplete(Object status, Map<String, Object> attachments) {
        }
     ...
     */
    CompletableFuture<?> sendMessage(byte[] message, int compressFlag, boolean eos);
