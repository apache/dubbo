...
public interface ServerStream extends Stream {
     ...
     */
    CompletableFuture<?> complete(Object status, Map<String, Object> attachments, boolean isNeedReturnException, int exceptionCode);
     ...
     */
    CompletableFuture<?> sendMessage(HttpMessage message);
