...
public class NettyEpollClientToEpollServerTest extends ClientToServerTest {
    ...
    protected ExchangeServer newServer(int port, Replier<?> receiver) throws RemotingException {
        ...
        URL url = URL.valueOf("exchange://localhost:" + port + "?epoll=true");
    ...
    protected ExchangeChannel newClient(int port) throws RemotingException {
        // add heartbeat cycle to avoid unstable ut.
        URL url = URL.valueOf("exchange://localhost:" + port + "?client=netty&timeout=3000&epoll=true");
        url = url.addParameter(Constants.HEARTBEAT_KEY, 600 * 1000);
