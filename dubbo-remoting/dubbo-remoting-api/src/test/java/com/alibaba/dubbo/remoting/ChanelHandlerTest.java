...
public class ChanelHandlerTest extends TestCase {
		...
		while (run) {
			try {
				...
				if (t != null
						...
						&& (t.getCause().getClass() == java.net.ConnectException.class || t.getCause().getClass() == java.net.ConnectException.class)) {
	...
	static class PeformanceTestHandler extends ExchangeHandlerAdapter {
		 ...
		 * 
		 * @see
		 * com.alibaba.dubbo.remoting.transport.support.ChannelHandlerAdapter
		 * #caught(com.alibaba.dubbo.remoting.Channel, java.lang.Throwable)
		 */
		@Override
