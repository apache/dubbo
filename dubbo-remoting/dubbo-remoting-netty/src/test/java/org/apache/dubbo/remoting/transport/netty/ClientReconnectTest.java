...
public class ClientReconnectTest {
    ...
    public void testReconnectWarnLog() throws RemotingException, InterruptedException {
        ...
        String url = "exchange://127.0.0.2:" + port + "/client.reconnect.test?check=false&client=netty&"
    ...
    public Client startClient(int port, int reconnectPeriod) throws RemotingException {
        final String url = "exchange://127.0.0.1:" + port + "/client.reconnect.test?check=false&client=netty&" + Constants.RECONNECT_KEY + "=" + reconnectPeriod;
        return Exchangers.connect(url);
    }

    public Server startServer(int port) throws RemotingException {
        final String url = "exchange://127.0.0.1:" + port + "/client.reconnect.test?server=netty";
