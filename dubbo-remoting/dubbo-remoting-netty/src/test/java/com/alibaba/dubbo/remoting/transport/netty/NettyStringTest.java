...
/**
 * User: heyman Date: 4/26/11 Time: 4:13 PM
 */
public class NettyStringTest {
	...
	public static void setUp() throws Exception {
		...
		client = Exchangers.connect(URL.valueOf("telnet://127.0.0.1:" + port + "?client=netty"),
	...
	public void testHandler() throws Exception {
		// Thread.sleep(20000);
		/*
		 * client.request("world\r\n"); Future future = client.request("world",
		 * 10000); String result = (String)future.get();
