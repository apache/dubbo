...
public class MonitorFilterTest {
    ...
    private final Invoker<MonitorService> serviceInvoker = new Invoker<MonitorService>() {
        ...
        public URL getUrl() {
            try {
                return URL.valueOf("dubbo://" + NetUtils.getLocalHost() + ":20880?" + Constants.APPLICATION_KEY + "=abc&side=consumer&" + Constants.MONITOR_KEY + "=" + URLEncoder.encode("dubbo://" + NetUtils.getLocalHost() + ":7070", "UTF-8"));
