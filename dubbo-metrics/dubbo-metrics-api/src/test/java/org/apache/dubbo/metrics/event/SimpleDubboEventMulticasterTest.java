...
public class SimpleDubboEventMulticasterTest {

    private TimeCounterEventMulticaster eventMulticaster;
    ...
    @BeforeEach
    public void setup() {
        eventMulticaster = new TimeCounterEventMulticaster();
        objects = new Object[] {obj};
        eventMulticaster.addListener(new AbstractMetricsKeyListener(null) {
        ...
        requestEvent = new TimeCounterEvent(applicationModel, null, TimePair.start()) {};
    }
