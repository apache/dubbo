...
public abstract class TimeCounterEvent extends MetricsEvent {
    ...
    public TimeCounterEvent(ApplicationModel source, TypeWrapper typeWrapper, TimePair timePair) {
        super(source, typeWrapper);
        this.timePair = timePair;
    }

    public TimeCounterEvent(ApplicationModel source, String appName, TypeWrapper typeWrapper, TimePair timePair) {
        super(source, appName, typeWrapper);
        this.timePair = timePair;
    }
