 ...
 * BaseMetricsEvent.
 */
public abstract class MetricsEvent extends DubboEvent {
    ...
    public MetricsEvent(ApplicationModel source, TypeWrapper typeWrapper) {
        this(source, null, typeWrapper);
    }

    public MetricsEvent(ApplicationModel source, String appName, TypeWrapper typeWrapper) {
        super(source);
