 ...
 */
package org.apache.dubbo.config.spring.boot.conditional5;
 ...
 * use static @Bean method to config ReferenceBean
 */
@SpringBootTest(
    properties = {
    ...
    classes = {
        JavaConfigReferenceBeanConditionalTest5.class
    }
)
@Configuration
//@ComponentScan
@EnableDubbo
public class JavaConfigReferenceBeanConditionalTest5 {
    ...
    public static class AnnotationBeanConfiguration {
        ...
        public static ReferenceBean<HelloService> helloService() {
