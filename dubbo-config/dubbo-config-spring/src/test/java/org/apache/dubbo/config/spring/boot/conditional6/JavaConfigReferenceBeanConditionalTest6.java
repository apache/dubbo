 ...
 */
package org.apache.dubbo.config.spring.boot.conditional6;
 ...
 * use two bean with override method to config ReferenceBean
 */
@SpringBootTest(
    properties = {
    ...
    classes = {
        JavaConfigReferenceBeanConditionalTest6.class
    }
)
@Configuration
//@ComponentScan
@EnableDubbo
public class JavaConfigReferenceBeanConditionalTest6 {
    ...
    public void testConsumer() {
        ...
        Assertions.assertNotNull(helloServiceMap.get("hello"));
    ...
    public static class AnnotationBeanConfiguration {
        ...
        @Bean("hello")
        @DubboReference(group = "${myapp.group}", init = false)
        public ReferenceBean<HelloService> helloService(User user) {
            return new ReferenceBean();
        }
