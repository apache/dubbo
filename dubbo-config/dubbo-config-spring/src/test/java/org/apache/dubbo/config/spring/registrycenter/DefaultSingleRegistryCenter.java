...
public class DefaultSingleRegistryCenter implements SingleRegistryCenter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DefaultSingleRegistryCenter.class);
    ...
    public void startup() throws RpcException {
        try {
            ...
            logger.info("The DefaultSingleRegistryCenter is started successfully");
        } catch (Exception exception) {
            throw new RpcException("Failed to initialize DefaultSingleRegistryCenter instance", exception);
        }
    }
    ...
    public RegistryConfig getRegistryConfig() {
        return new RegistryConfig("zookeeper://" + this.zookeeperServer.getConnectString());
    }
    ...
    public void shutdown() throws RpcException {
        try {
            ...
            logger.info("The DefaultSingleRegistryCenter is shutdown successfully");
        } catch (IOException exception) {
            throw new RpcException("Failed to close DefaultSingleRegistryCenter instance", exception);
        }
    }
}
