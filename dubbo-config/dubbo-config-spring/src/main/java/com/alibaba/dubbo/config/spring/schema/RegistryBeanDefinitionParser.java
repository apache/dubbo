 ...
 *
 * @author: zhangyinyue
 * @Createdate: 2017年09月22日 10:40
 */
public class RegistryBeanDefinitionParser extends ValueBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public RegistryBeanDefinitionParser(Class<?> beanClass, boolean required){
