...
import static org.apache.dubbo.config.spring.util.SpringUtils.unwrap;
...
public class ConfigurationBeanBindingPostProcessor implements BeanPostProcessor, BeanFactoryAware, PriorityOrdered {
    ...
    private List<DubboConfigBeanCustomizer> configurationBeanCustomizers = null;
    ...
    /**
     * Get the {@link List} of {@link DubboConfigBeanCustomizer ConfigurationBeanCustomizers}
     *
     * @return non-null
     * @since 1.0.6
     */
    public List<DubboConfigBeanCustomizer> getConfigurationBeanCustomizers() {
    ...
    public void setConfigurationBeanCustomizers(Collection<DubboConfigBeanCustomizer> configurationBeanCustomizers) {
        List<DubboConfigBeanCustomizer> customizers =
            new ArrayList<>(configurationBeanCustomizers);
        sort(customizers);
    ...
    private void initBindConfigurationBeanCustomizers() {
        Collection<DubboConfigBeanCustomizer> customizers =
            beansOfTypeIncludingAncestors(beanFactory, DubboConfigBeanCustomizer.class).values();
        setConfigurationBeanCustomizers(customizers);
    }

    private void customize(String beanName, Object configurationBean) {
        for (DubboConfigBeanCustomizer customizer : getConfigurationBeanCustomizers()) {
