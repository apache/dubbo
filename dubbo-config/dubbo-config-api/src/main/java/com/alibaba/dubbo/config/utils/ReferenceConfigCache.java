 ...
 * object for the framework which create {@link ReferenceConfig} frequently.
 * <p>
 * You can implement and use your own {@link ReferenceConfig} cache if you need
 * use complicate strategy.
 *
 * @author ding.lid
 */
public class ReferenceConfigCache {
	...
	/**
	 * Get the cache use default name and {@link #DEFAULT_KEY_GENERATOR} to
	 * generate cache key. Create cache if not existed yet.
	 */
	...
	/**
	 * Get the cache use specified name and {@link KeyGenerator}. Create cache
	 * if not existed yet.
	 */
	...
	/**
	 * Get the cache use specified {@link KeyGenerator}. Create cache if not
	 * existed yet.
	 */
	...
	/**
	 * Create the key with the <b>Group</b>, <b>Interface</b> and <b>version</b>
	 * attribute of {@link ReferenceConfig}.
	 * <p>
