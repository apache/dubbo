 ...
 * </h1>
 * <p>
 * For dubbo，the smallest unit created for the service(consumer or provider) is the interface.
 * <p>
 * Interface level configuration item abstract definition, whether it is the consumer or the provider, it is a specific distinction on our interface configuration item
 * <p>
 * Under this, let us clearly distinguish between the consumer or the server.
 *
 * @export
