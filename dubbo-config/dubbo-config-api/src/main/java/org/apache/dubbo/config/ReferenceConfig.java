...
import static org.apache.dubbo.common.constants.CommonConstants.K8S_CLUSTER_DOMAIN;
...
import static org.apache.dubbo.common.constants.CommonConstants.K8S_POD_NAMESPACE;
...
public class ReferenceConfig<T> extends ReferenceConfigBase<T> {
    ...
    private void meshModeHandleUrl(Map<String, String> referenceParameters) {
        ...
        if (StringUtils.isEmpty(podNamespace)) {
            if (StringUtils.isEmpty(System.getenv(K8S_POD_NAMESPACE))) {
                ...
                podNamespace = System.getenv(K8S_POD_NAMESPACE);
            }
        }
        ...
        String clusterDomain = Optional.ofNullable(System.getenv(K8S_CLUSTER_DOMAIN)).orElse(DEFAULT_CLUSTER_DOMAIN);
