...
public class NacosDubboServiceProviderBootstrap {
    ...
    public static void main(String[] args) {
        ...
        DubboBootstrap.getInstance()
                ...
                .registry("nacos", builder -> builder.address("nacos://113.96.131.199:8849?username=nacos&password=nacos")
...
//                .protocol("rest", builder -> builder.port(9090).name("rest"))
                .service(builder -> builder.id("echo").interfaceClass(EchoService.class).ref(new EchoServiceImpl()).protocolIds("dubbo").version("1.0.1").group("test"))
