...
public class DefaultRequestMappingRegistryTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        MetadataServiceDelegation metadataServiceDelegation = applicationModel.getDefaultModule()
                .getBeanFactory()
        ...
        ConfigurableMetadataServiceExporter metadataServiceExporter = new ConfigurableMetadataServiceExporter(applicationModel, metadataServiceDelegation);
