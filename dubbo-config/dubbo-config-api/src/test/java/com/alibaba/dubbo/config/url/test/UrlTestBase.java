...
public class UrlTestBase {
	...
	protected Object servConfTable[][] = {
			...
			{ "document", "document", "string", "",
					"http://b2b-doc.alibaba-inc.com/display/RC/dubbo_devguide.htm?testquery=你好你好", "", "", "", "", "" },
	 ...
	 * @param column
	 */
	protected void assertUrlStringWithLocalTable(String paramStringFromDb, Object[][] dataTable, String configName,
			int column) {
