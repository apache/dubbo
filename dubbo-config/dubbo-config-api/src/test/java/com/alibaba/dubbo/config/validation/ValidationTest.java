	...
	public void testGenericValidation() {
		...
		try {
			...
			try {
				...
				validationService.$invoke("save", new String[] { ValidationParameter.class.getName() },
				...
				// Delete OK
				validationService.$invoke("delete", new String[] { long.class.getName(), String.class.getName() },
						new Object[] { 2, "abc" });
