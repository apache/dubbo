...
public class InvokerSideConfigUrlTest extends UrlTestBase {
	...
	private Object regConfForConsumerTable[][] = {
			...
			// "", ""},
			// {"file", "registry.file", "string", "",
			// "regConfForServiceTable.log", "", "", "", "", ""},
	...
	private Object refConfTable[][] = {
			...
			// {"local", "local", "string", "false", "HelloServiceLocal",
			// "true", "", "", "", ""},
			// {"local", "local", "string", "false", "true", "", "", "", "",
			// ""},
			// {"mock", "mock", "string", "false",
			// "dubbo.test.HelloServiceMock", "true", "", "", "", ""},
	...
	@Ignore
	@Test
	// 注册中心的参数不会在与consumer的query merge
