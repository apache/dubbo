...
public class ScriptStateRouter<T> extends AbstractStateRouter<T> {
    ...
    protected BitList<Invoker<T>> doRoute(
        ...
        logger.info(
                "[SCRIPT-ROUTER] ScriptStateRouter.doRoute called with {} invokers [Thread: {}]",
                invokers.size(),
        ...
        if (engine == null || function == null) {
            logger.info(
                    "[SCRIPT-ROUTER] Engine or function is null, returning all invokers [Thread: {}]",
                    Thread.currentThread().getName());
        ...
        logger.info(
                "[SCRIPT-ROUTER] Executing script evaluation [Thread: {}]",
                Thread.currentThread().getName());
        ...
        logger.info(
                "[SCRIPT-ROUTER] Script evaluation result: {} invokers [Thread: {}]",
                result.size(),
                Thread.currentThread().getName());
        return result;
    }
