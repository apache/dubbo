...
public class RetryDecodeableRpcInvocation extends DecodeableRpcInvocation implements RetryDecodeable {
    ...
    private void retryDecode(Channel channel, ExceptionProcessor expProcessor) throws IOException {
        ObjectInput in = getObjectInput();
