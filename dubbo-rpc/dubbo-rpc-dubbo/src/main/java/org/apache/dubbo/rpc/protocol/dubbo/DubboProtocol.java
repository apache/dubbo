...
public class DubboProtocol extends AbstractProtocol {
    ...
    Invoker<?> getInvoker(Channel channel, Invocation inv) throws RemotingException {
        ...
        String version = (String) inv.getAttachments().get(Constants.VERSION_KEY);
        if ("0.0.0".equals(version)) {
            version = null;
        }
        DubboExporterKey dubboExporterKey = new DubboExporterKey(port, path, version, (String) inv.getAttachments().get(Constants.GROUP_KEY));
