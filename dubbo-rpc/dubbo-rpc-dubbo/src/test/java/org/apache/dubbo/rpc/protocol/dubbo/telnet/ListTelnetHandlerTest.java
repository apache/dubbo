...
public class ListTelnetHandlerTest {
    ...
    public void testListDetailService() throws RemotingException {
        ...
        ProviderModel providerModel = new ProviderModel("org.apache.dubbo.rpc.protocol.dubbo.support.DemoService", new DemoServiceImpl(), ApplicationModel.initServiceModel(DemoService.class));
