...
//    private final List<ResteasyClient> clients = Collections.synchronizedList(new LinkedList<>());
    ...
    protected <T> T doRefer(Class<T> serviceType, URL url) throws RpcException {
        ...
        String uri = url.toFullString();
        if (!connectionMonitor.contains(uri)) {
            ...
            connectionMonitor.addConnectionManager(uri, connectionManager);
        }
...
//            connectionManagers.add(connectionManager);
        ...
        public PoolingHttpClientConnectionManager getConnectionManager(String key) {
            return connectionManagers.get(key);
        }

        public boolean contains(String key) {
            return connectionManagers.containsKey(key);
        }
