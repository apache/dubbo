...
public class TriHttp2LocalFlowController implements Http2LocalFlowController {
    ...
    public TriHttp2LocalFlowController(Http2Connection connection,
        ...
        connection.addListener(new Http2ConnectionAdapter() {
            ...
            public void onStreamActive(Http2Stream stream) {
                ...
                stream.setProperty(stateKey, new TriHttp2LocalFlowController.DefaultState(stream, initialWindowSize));
            }
            ...
            public void onStreamClosed(Http2Stream stream) {
                try {
                    ...
                    TriHttp2LocalFlowController.FlowState state = state(stream);
    ...
    public void initialWindowSize(int newWindowSize) throws Http2Exception {
        ...
        TriHttp2LocalFlowController.WindowUpdateVisitor visitor = new TriHttp2LocalFlowController.WindowUpdateVisitor(delta);
    ...
    public void consumeTriBytes(Http2Stream stream, int numBytes)  throws Http2Exception {
        ...
        if (stream != null && !isClosed(stream)) {
            ...
            consumeAllBytes(state(stream), numBytes);
        }
        return ;
    }
    ...
    private boolean consumeAllBytes(TriHttp2LocalFlowController.FlowState state, int numBytes) throws Http2Exception {
    ...
    public void receiveFlowControlledFrame(Http2Stream stream, ByteBuf data, int padding,
        ...
        TriHttp2LocalFlowController.FlowState connectionState = connectionState();
    ...
    private TriHttp2LocalFlowController.FlowState connectionState() {
        return connection.connectionStream().getProperty(stateKey);
    }

    private TriHttp2LocalFlowController.FlowState state(Http2Stream stream) {
     ...
     * received.
     */
    private final class AutoRefillState extends TriHttp2LocalFlowController.DefaultState {
     ...
     */
    private class DefaultState implements TriHttp2LocalFlowController.FlowState {
     ...
     * be exchanged.
     */
    private static final TriHttp2LocalFlowController.FlowState REDUCED_FLOW_STATE = new TriHttp2LocalFlowController.FlowState() {
