...
public class StubServerCall extends ServerCall {
    ...
    public StubServerCall(Invoker<?> invoker, ServerStream serverStream, FrameworkModel frameworkModel, String serviceName, String methodName, Executor executor) {
        super(invoker, serverStream, frameworkModel, serviceName, methodName, executor);
        this.methodDescriptor = (StubMethodDescriptor) invoker.getUrl().getServiceModel().getServiceModel()
