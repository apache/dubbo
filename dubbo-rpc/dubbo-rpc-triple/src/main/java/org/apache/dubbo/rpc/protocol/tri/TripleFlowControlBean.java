...
public class TripleFlowControlBean {
    ...
    public TripleFlowControlBean(Http2Connection http2Connection, int windowSizeIncrement, Http2WindowUpdateFrame http2WindowUpdateFrame){
