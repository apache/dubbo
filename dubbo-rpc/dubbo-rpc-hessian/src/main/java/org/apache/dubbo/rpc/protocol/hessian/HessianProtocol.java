...
public class HessianProtocol extends AbstractProxyProtocol {
    ...
    protected <T> T doRefer(Class<T> serviceType, URL url) throws RpcException {
        ...
        String client = url.getParameter(org.apache.dubbo.remoting.Constants.CLIENT_KEY, DEFAULT_HTTP_CLIENT);
        ...
        public void handle(HttpServletRequest request, HttpServletResponse response)
            ...
            if (!request.getMethod().equalsIgnoreCase("POST")) {
                ...
                while (enumeration.hasMoreElements()) {
                    ...
                    if (key.startsWith(org.apache.dubbo.remoting.Constants.DEFAULT_EXCHANGER)) {
                        RpcContext.getContext().setAttachment(key.substring(org.apache.dubbo.remoting.Constants.DEFAULT_EXCHANGER.length()),
