...
public class EnumBak {
	...
	public void testNormal() {
		...
		URL serviceurl = URL.valueOf("dubbo://127.0.0.1:" + port + "/test?proxy=jdk" + "&interface="
				+ DemoService.class.getName() + "&timeout=" + Integer.MAX_VALUE);
	...
	public void testExportService() throws InterruptedException {
		...
		// consumerurl);
		// DemoService demoProxy =
		// (DemoService)proxyFactory.createProxy(reference);
		// // System.out.println(demoProxy.getThreadName());
	...
	public void testGenricEnumCompat() {
		...
		Object obj = demoProxy.$invoke("enumlength", new String[] { Type[].class.getName() },
				new Object[] { new Type[] { Type.High, Type.High } });
	...
	public void testGenricCustomArg() {
		...
		Object obj = demoProxy.$invoke("get", new String[] { "com.alibaba.dubbo.rpc.CustomArgument" },
				new Object[] { arg });
		System.out.println("obj---------->" + obj);
		reference.destroy();
	}
