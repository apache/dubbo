...
public class MvcRequestMappingHandlerAdapter extends RequestMappingHandlerAdapter {
    ...
    public void afterPropertiesSet() {
        ...
        HashSet<HttpMessageConverter<?>> httpMessageConverters = new HashSet<HttpMessageConverter<?>>();
        MvcConfigurationSupport.addDefaultHttpMessageConverters(httpMessageConverters);
        setMessageConverters(new ArrayList<HttpMessageConverter<?>>(httpMessageConverters));
