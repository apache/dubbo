...
public class ConsumerModel {
    ...
    public ConsumerModel(String serviceName, Class<?> interfaceClass, Method[] methods, Map<String, Object> attributes) {
        this.serviceMetadata = new ServiceMetadata(serviceName, interfaceClass);
