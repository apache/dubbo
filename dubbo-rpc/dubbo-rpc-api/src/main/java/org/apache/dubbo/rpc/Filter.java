...
public interface Filter {
    ...
    interface Listener {
         ...
         * If you implement both {@link #onMessage(Result, Invoker, Invocation)} and this method, this will not be called.
         */
        @Deprecated
        ...
        // TODO: change this to non-default method when onResponse method is deleted
