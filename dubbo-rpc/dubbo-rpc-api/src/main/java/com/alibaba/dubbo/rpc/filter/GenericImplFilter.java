...
public class GenericImplFilter implements Filter {
				...
				try {
					...
					if (ProtocolUtils.isBeanGenericSerialization(generic)) {
						if (value == null) {
							...
							throw new RpcException(new StringBuilder(64).append("The type of result value is ")
									.append(value.getClass().getName()).append(" other than ")
									.append(JavaBeanDescriptor.class.getName()).append(", and the result is ")
	...
	private void error(String expected, String actual) throws RpcException {
		throw new RpcException(new StringBuilder(32).append("Generic serialization [")
				...
				.append(expected).append(" and your message type is ").append(actual).toString());
	}
