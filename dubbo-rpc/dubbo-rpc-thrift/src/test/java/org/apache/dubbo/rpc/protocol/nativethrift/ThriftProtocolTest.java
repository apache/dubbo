...
public class ThriftProtocolTest {
    ...
    public void testThriftProtocol() throws TException{
        ...
        URL url = URL.valueOf(org.apache.dubbo.rpc.protocol.thrift.ThriftProtocol.NAME + "://127.0.0.1:5341/" + DemoService.Iface.class.getName() + "?version=1.0.0&thrift.overload.method=true");
    ...
    public void testThriftProtocolMultipleServices() throws TException{
        ...
        URL url1 = URL.valueOf(org.apache.dubbo.rpc.protocol.thrift.ThriftProtocol.NAME + "://127.0.0.1:5342/" + DemoService.Iface.class.getName() + "?version=1.0.0&thrift.overload.method=true");
        ...
        URL url2 = URL.valueOf(org.apache.dubbo.rpc.protocol.thrift.ThriftProtocol.NAME + "://127.0.0.1:5342/" + UserService.Iface.class.getName() + "?version=1.0.0&thrift.overload.method=true");
