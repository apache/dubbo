...
public class GenericServiceConfig implements Serializable {
    ...
    public GenericServiceConfig(String group, String version, String service, String method, String[] params, String[] paramsType) {
        this.group = group;
        this.version = version;
        this.service = service;
        this.method = method;
    ...
    public GenericServiceConfig(String service, String method, String[] params ,String[] paramsType) {
        this.service = service;
        this.method = method;
        this.params = params;
        this.paramsType = paramsType;
