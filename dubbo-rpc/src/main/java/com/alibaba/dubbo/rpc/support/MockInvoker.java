...
final public class MockInvoker<T> implements Invoker<T> {
    	...
    	if (!StringUtils.isBlank(mock)){
            ...
            if (mock.startsWith(Constants.RETURN_PREFIX)) {
                ...
                return errorResult;
            	 ...
            	 Class<?> serviceType = ReflectUtils.forName(url.getServiceName());
                 ...
                 try {
                     ...
                     try {
                         ...
                         Invoker<?> invoker = proxyFactory.getInvoker(mockObject, (Class<T>)serviceType, url);
    ...
    private String normallizeMock(String mock) {
    	if (mock == null || mock.trim().length() ==0){
    		return mock;
    	} else if ("true".equalsIgnoreCase(mock.trim()) || "fail".equalsIgnoreCase(mock.trim())){
    		mock = url.getServiceName();
    	}
