 ...
 * @since 2.7.5
 */
public class HeaderParamParameterProcessor implements AnnotatedMethodParameterProcessor {
    ...
    public void process(AnnotationMirror annotation, VariableElement parameter, int parameterIndex,
        ...
        String headerName = getValue(annotation);

        RequestMetadata requestMetadata = restMethodMetadata.getRequest();
        // Add the placeholder as header value
        requestMetadata.addHeader(headerName, buildDefaultValuePlaceholder(parameterIndex));
    }
}
