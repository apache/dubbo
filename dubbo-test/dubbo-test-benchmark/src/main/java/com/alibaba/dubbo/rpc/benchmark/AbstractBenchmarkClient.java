...
/**
 * Abstract benchmark client,test for difference scenes Usage:
 * -Dwrite.statistics=false BenchmarkClient serverIP serverPort concurrents
 * timeout codectype requestSize runtime(seconds) clientNums
 * 
...
public abstract class AbstractBenchmarkClient {
	...
	public abstract ClientRunnable getClientRunnable(String targetIP, int targetPort, int clientNums, int rpcTimeout,
			CyclicBarrier barrier, CountDownLatch latch, long startTime, long endTime) throws IllegalArgumentException,
