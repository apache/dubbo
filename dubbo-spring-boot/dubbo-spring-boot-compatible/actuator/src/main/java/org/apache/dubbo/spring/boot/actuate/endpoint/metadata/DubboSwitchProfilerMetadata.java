...
/**
 * Dubbo Switch Profiler
 *
 * @since 3.3.0
 */
@Component
public class DubboSwitchProfilerMetadata {

    public Map<String, Object> disableDetailProfiler() {
        ProfilerSwitch.disableDetailProfiler();
        return Collections.singletonMap("WARN", "Dubbo Invocation Profiler has been disabled");
    }

    public Map<String, Object> disableSimpleProfiler() {
    ...
    public Map<String, Object> enableSimpleProfiler() {
