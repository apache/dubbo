 ...
 */
@Component
public class DubboGetRecentRouterMetadata {

    @Autowired
    private ApplicationModel applicationModel;

    public Map<String, Object> getRecentRouter() {
        ...
        routerMap.put(
                "Recent router snapshot",
                Arrays.stream(routerSnapshotSwitcher.cloneSnapshot())
