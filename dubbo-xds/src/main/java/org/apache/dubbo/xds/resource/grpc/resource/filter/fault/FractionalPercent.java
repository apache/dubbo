...
final class FractionalPercent {
    ...
    static FractionalPercent perHundred(int numerator) {
        return FractionalPercent.create(numerator,
                FractionalPercent.DenominatorType.HUNDRED);
    }

    static FractionalPercent perTenThousand(int numerator) {
        return FractionalPercent.create(numerator,
                FractionalPercent.DenominatorType.TEN_THOUSAND);
    }

    static FractionalPercent perMillion(int numerator) {
        return FractionalPercent.create(numerator,
                FractionalPercent.DenominatorType.MILLION);
    }

    static FractionalPercent create(
            int numerator,
            FractionalPercent.DenominatorType denominatorType) {
