...
public final class MatcherParser {
    ...
    public static HeaderMatcher parseHeaderMatcher(
        ...
        switch (proto.getHeaderMatchSpecifierCase()) {
            ...
            case SAFE_REGEX_MATCH:
                String rawPattern = proto.getSafeRegexMatch()
                        .getRegex();
            ...
            case RANGE_MATCH:
                Range rangeMatch = new Range(proto.getRangeMatch()
                        .getStart(), proto.getRangeMatch()
                        .getEnd());
            ...
            case STRING_MATCH:
                return HeaderMatcher.forString(proto.getName(), parseStringMatcher(proto.getStringMatch()),
                        proto.getInvertMatch());
    ...
    public static StringMatcher parseStringMatcher(
        ...
        switch (proto.getMatchPatternCase()) {
            ...
            case SAFE_REGEX:
                return StringMatcher.forSafeRegEx(Pattern.compile(proto.getSafeRegex()
                        .getRegex()));
            case CONTAINS:
