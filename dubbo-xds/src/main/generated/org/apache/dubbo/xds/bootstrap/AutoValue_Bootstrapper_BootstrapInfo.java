...
final class AutoValue_Bootstrapper_BootstrapInfo extends Bootstrapper.BootstrapInfo {
  ...
  @Override
  public ImmutableList<Bootstrapper.ServerInfo> servers() {
    return servers;
  }
  ...
  @Override
  public ImmutableMap<String, Bootstrapper.AuthorityInfo> authorities() {
    return authorities;
  }
  ...
  static final class Builder extends Bootstrapper.BootstrapInfo.Builder {
    ...
    @Override
    public Bootstrapper.BootstrapInfo.Builder servers(List<Bootstrapper.ServerInfo> servers) {
    ...
    @Override
    public Bootstrapper.BootstrapInfo.Builder certProviders(@Nullable Map<String, Bootstrapper.CertificateProviderInfo> certProviders) {
      this.certProviders = (certProviders == null ? null : ImmutableMap.copyOf(certProviders));
      return this;
    }
    @Override
    public Bootstrapper.BootstrapInfo.Builder serverListenerResourceNameTemplate(@Nullable String serverListenerResourceNameTemplate) {
      this.serverListenerResourceNameTemplate = serverListenerResourceNameTemplate;
      return this;
    }
    @Override
    public Bootstrapper.BootstrapInfo.Builder clientDefaultListenerResourceNameTemplate(String clientDefaultListenerResourceNameTemplate) {
    ...
    @Override
    public Bootstrapper.BootstrapInfo.Builder authorities(Map<String, Bootstrapper.AuthorityInfo> authorities) {
