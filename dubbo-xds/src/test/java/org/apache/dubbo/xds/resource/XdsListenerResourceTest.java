...
class XdsListenerResourceTest {
    ...
    void testParseValidListener() {
        ...
        Listener listener = Listener.newBuilder()
                ...
                .setAddress(Address.newBuilder()
                        .setSocketAddress(
                                SocketAddress.newBuilder().setAddress("0.0.0.0").setPortValue(8080)))
                .addFilterChains(FilterChain.newBuilder()
                        .addFilters(Filter.newBuilder()
                                .setName("envoy.filters.network.http_connection_manager")
                                .setTypedConfig(
                                        com.google.protobuf.Any.pack(io.envoyproxy.envoy.extensions.filters.network
                                                .http_connection_manager.v3.HttpConnectionManager.newBuilder()
                                                .addHttpFilters(io.envoyproxy.envoy.extensions.filters.network
                                                        .http_connection_manager.v3.HttpFilter.newBuilder()
                                                        .setName("envoy.filters.http.router")
                                                        .setTypedConfig(com.google.protobuf.Any.pack(io.envoyproxy.envoy
                                                                .extensions.filters.http.router.v3.Router.newBuilder()
                                                                .build())))
                                                .setRouteConfig(
                                                        io.envoyproxy.envoy.config.route.v3.RouteConfiguration
                                                                .newBuilder()
                                                                .setName("test-route")
                                                                .addVirtualHosts(io.envoyproxy.envoy.config.route.v3
                                                                        .VirtualHost.newBuilder()
                                                                        .setName("test-host")
                                                                        .addDomains("*")
                                                                        .addRoutes(io.envoyproxy.envoy.config.route.v3
                                                                                .Route.newBuilder()
                                                                                .setMatch(io.envoyproxy.envoy.config
                                                                                        .route.v3.RouteMatch
                                                                                        .newBuilder()
                                                                                        .setPrefix("/"))
                        ...
                        .addFilters(Filter.newBuilder()
                                ...
                                .setTypedConfig(
                                        com.google.protobuf.Any.pack(io.envoyproxy.envoy.extensions.filters.network
                                                ...
                                                .build()))))
                .addFilterChains(FilterChain.newBuilder()
                        .addFilters(Filter.newBuilder().setName("envoy.filters.network.tcp_proxy")))
                .build();
    ...
    void testParseListenerWithoutAddress() {
        ...
        Listener listener = Listener.newBuilder()
                ...
                .addFilterChains(FilterChain.newBuilder()
                        .addFilters(Filter.newBuilder()
                                .setName("envoy.filters.network.http_connection_manager")
                                .setTypedConfig(com.google.protobuf.Any.pack(io.envoyproxy.envoy.extensions.filters
                                        .network.http_connection_manager.v3.HttpConnectionManager.newBuilder()
                                        .addHttpFilters(
                                                io.envoyproxy.envoy.extensions.filters.network.http_connection_manager
                                                        .v3.HttpFilter.newBuilder()
                                                        .setName("envoy.filters.http.router")
                                                        .setTypedConfig(com.google.protobuf.Any.pack(io.envoyproxy.envoy
                                                                .extensions.filters.http.router.v3.Router.newBuilder()
                                                                .build())))
    ...
    void testParseListenerWithTlsContext() {
        ...
        Listener listener = Listener.newBuilder()
                ...
                .setAddress(Address.newBuilder()
                        .setSocketAddress(
                                SocketAddress.newBuilder().setAddress("0.0.0.0").setPortValue(8443)))
                .addFilterChains(FilterChain.newBuilder()
                        .setTransportSocket(
    ...
    void testExtractResourceName() {
        // Arrange
        Listener listener = Listener.newBuilder().setName("test-listener").build();
    ...
    void testParseListenerWithComplexConfiguration() {
        ...
        Listener listener = Listener.newBuilder()
                ...
                .addFilterChains(FilterChain.newBuilder()
                        .setFilterChainMatch(io.envoyproxy.envoy.config.listener.v3.FilterChainMatch.newBuilder()
                                .setDestinationPort(com.google.protobuf.UInt32Value.newBuilder()
                                        .setValue(8080)))
                        .addFilters(Filter.newBuilder()
                                .setName("envoy.filters.network.http_connection_manager")
                                .setTypedConfig(
