...
public class MultipleServiceDiscoveryTest {
    ...
    public void testOnEvent() {
        try {
            ...
            zookeeperConnectionAddress1 = "multiple://127.0.0.1:2181?reference-registry=127.0.0.1:2181?enableEmptyProtection=false&child.a1=zookeeper://127.0.0.1:2181";
            ...
            Mockito.when(serviceDiscoveryMock.getRemoteMetadata(Mockito.anyString(), Mockito.anyList())).thenReturn(metadataInfo);
            serviceDiscoveries.set(multipleServiceDiscovery, Collections.singletonMap("child.a1", serviceDiscoveryMock));
