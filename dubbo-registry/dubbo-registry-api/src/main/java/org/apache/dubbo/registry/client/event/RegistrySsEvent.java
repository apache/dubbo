...
public class RegistrySsEvent extends RegistryEvent {
    ...
    public RegistrySsEvent(ApplicationModel applicationModel, String serviceKey, List<String> serviceDiscoveryNames) {
