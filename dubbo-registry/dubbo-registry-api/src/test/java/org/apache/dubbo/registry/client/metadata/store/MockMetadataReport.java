...
public class MockMetadataReport extends AbstractMetadataReport {
    ...
    private final static Logger logger = LoggerFactory.getLogger(MockMetadataReport.class);

    private Gson gson = new Gson();

    private Map<String, String> reversion2MetadataIdentifier = new HashMap<>();
    ...
    public void publishAppMetadata(SubscriberMetadataIdentifier identifier, MetadataInfo metadataInfo) {
        ...
        reversion2MetadataIdentifier.put(identifier.getRevision(), content);
    }

    @Override
    public MetadataInfo getAppMetadata(SubscriberMetadataIdentifier identifier, Map<String, String> instanceMetadata) {
        String content = reversion2MetadataIdentifier.get(identifier.getRevision());
