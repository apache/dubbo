...
//        etcdServiceDiscovery.destroy();
    ...
    public void testRegistry() throws Exception {
        ServiceInstance serviceInstance = new DefaultServiceInstance("EtcdTestService", "127.0.0.1", 8080);
    ...
    public void testUnRegistry() throws Exception {
        ServiceInstance serviceInstance = new DefaultServiceInstance("EtcdTest2Service", "127.0.0.1", 8080);
        Assertions.assertNull(etcdServiceDiscovery.etcdClient.getKVValue(etcdServiceDiscovery.toPath(serviceInstance)));
        etcdServiceDiscovery.register(serviceInstance);
        Assertions.assertNotNull(etcdServiceDiscovery.etcdClient.getKVValue(etcdServiceDiscovery.toPath(serviceInstance)));
    ...
    public void testUpdate() throws Exception {
        DefaultServiceInstance serviceInstance = new DefaultServiceInstance("EtcdTest34Service", "127.0.0.1", 8080);
        Assertions.assertNull(etcdServiceDiscovery.etcdClient.getKVValue(etcdServiceDiscovery.toPath(serviceInstance)));
        etcdServiceDiscovery.register(serviceInstance);
        Assertions.assertNotNull(etcdServiceDiscovery.etcdClient.getKVValue(etcdServiceDiscovery.toPath(serviceInstance)));
    ...
    public void testGetInstances() throws Exception {
        ...
        etcdServiceDiscovery.register(new DefaultServiceInstance(serviceName, "127.0.0.1", 8080));
        etcdServiceDiscovery.register(new DefaultServiceInstance( serviceName, "127.0.0.1", 9809));
