...
# --- 1. Build only the provider module and its dependencies ---
echo "--- Building dubbo-demo-xds-provider and its dependencies... ---"
pushd ../../

# Build the provider module and all its dependencies automatically
echo "Building provider module and dependencies..."
...
# Find the JAR file created by the build
