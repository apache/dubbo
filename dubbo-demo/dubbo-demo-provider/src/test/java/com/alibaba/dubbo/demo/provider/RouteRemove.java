...
public class RouteRemove {
    ...
    public void start() {
        ...
        URL routeUrl = URL.valueOf("route://" + NetUtils.getLocalHost() + "/" + DemoService.class.getName() + "?category=routes&version=1.0.0&dynamic=false&priority=1&name=aaa&rule=" + URL.encode("consumer.host=" + NetUtils.getLocalHost() + " => provider.host=" + NetUtils.getLocalHost()));
