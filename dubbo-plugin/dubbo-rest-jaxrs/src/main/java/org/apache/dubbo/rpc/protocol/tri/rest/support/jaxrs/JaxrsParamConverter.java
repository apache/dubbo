...
public class JaxrsParamConverter {
    ...
    private final Map<Pair<Class<?>, Class<?>>, ParamConverter> cacheConverter =
    ...
    JaxrsParamConverter(FrameworkModel frameworkModel) {
        this.converters= getExtensionLoader(ParamConverter.class,frameworkModel).getActivateExtensions();
    }
    ...
    private  <T> ExtensionLoader<T> getExtensionLoader(Class<T> converterClass,FrameworkModel frameworkModel){
        ...
        try {
            ...
            Constructor<ExtensionLoader> constructor = clazz.getDeclaredConstructor(Class.class, ExtensionDirector.class, ScopeModel.class);
